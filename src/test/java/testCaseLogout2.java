...
public class testCaseLogout2 extends junit.framework.TestCase{
    ...
    public void testTestCaseLogout2() throws Exception {
        ...
        // Warning: verifyTextPresent may require manual changes
        try {
            assertTrue("Dado que estava com a sessão de Prof. Saúde e cliquei logout , então deveria ficar 'deslogado' ",driver.findElement(By.cssSelector("BODY")).getText().contains("Página Inicial"));
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
    }
